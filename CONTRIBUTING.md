...
The goal of this guide is to help you contribute as quickly and as easily possible. The guide is divided into two main pieces:
...
1.  Check that you're using the latest version. It's quite
...
*   If you can, also write a test. Testing is particularly difficult
    because most functions are called for their side-effects, but do
    the best you can.
